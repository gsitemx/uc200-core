...
final class ApiTokenController extends Controller
{
    ...
    private function availableScopes(): array
    {
        return [
            ...
            'crm_contacts:read' => 'CRM contactos lectura',
            'crm_contacts:write' => 'CRM contactos escritura',
            'crm_accounts:read' => 'CRM cuentas lectura',
            'crm_accounts:write' => 'CRM cuentas escritura',
            'crm_activities:read' => 'CRM actividad lectura',
            'crm_calls:read' => 'CRM llamadas lectura',
            'pbx_ami:read' => 'PBX estado AMI lectura',
            'pbx_originate:write' => 'PBX originate escritura',
            'calls_control:write' => 'Call control escritura',
            'security_fail2ban:read' => 'Security Center lectura',
            'security_bans:read' => 'Security bans lectura',
            'security_events:read' => 'Security eventos lectura',
            'security_bans:write' => 'Security acciones escritura',
